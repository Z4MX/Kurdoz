#!/usr/bin/ruby
#
# Kurdoz A.V bypass tool . version 1.0
#
# Generate encoded powershell with metasploit payloads,convert C & C# Templates to EXE's with MinGW & Monodevelop
#
#                  Created By Zanyar Matrix .
#                 Website: http://www.zanyarmatrix.com
#           YTB : https://www.youtube.com/ZANYARMATRIX  
#        FCB : https://www.facebook.com/ZanyarMatrixOfficial/
#
...
optparse = OptionParser.new do|opts|
    ...
    opts.banner = "Usage: kurdoz.rb [options]"
    opts.separator ""
